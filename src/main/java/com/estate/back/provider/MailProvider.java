...
// - 메일 서버 및 기타 메시지 전송 에이전트(MTA)에서 메일 전송, 수신, 중계를 할때 사용됨
// - 기본 포트 : TCP 25 (gmail에서는 587사용)

// TLS (Transport Layer Security) :
// - 전송 계층 보안
// - 인터넷에서 의사소통을 위한 개인 정보와 데이터 보안을 위해 사용되는 보안 프로토콜
// - 서버간 통신에서 데이터를 암호화하여 전송 및 수신
// - 이메일, 메시지 전송 암호화에 주로 사용
@Component
...
public class MailProvider {
    ...
    private String from;
    private final JavaMailSender javaMailSender; // 자바 메일 전송을 위한 의존성
